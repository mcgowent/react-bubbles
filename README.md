...
- [ ] Explain what a token is used for.
  ...
  To Login with extra security measures

- [ ] What steps can you take in your web apps to keep your data secure?

  Use tokens and not actual info being send and saved around the site

- [ ] Describe how web servers work.

  It is a computer that recieves and sends back data
